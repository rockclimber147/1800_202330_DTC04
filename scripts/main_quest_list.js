        ...
        navigator.geolocation.getCurrentPosition(async (position) => {                          // Get player position
            ...
            await firebase.auth().onAuthStateChanged(async (user) => {
                if (user) {
                    ...
                    user_accepted_quest_ids = user_doc.data().accepted_quests;
                    ...
                    user_completed_quest_ids = user_doc.data().completed_quests;
                    ...
                    update_map(accepted_quests_db);
                    update_quest_cards(accepted_quests_db)
                } else {
